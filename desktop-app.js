class DesktopMirrorApp {
    ...
    setupElectronListeners() {
        // Listen for signal server ready
        window.electronAPI.onSignalServerReady((event, port) => {
    ...
    setupEventListeners() {
        ...
        document.getElementById('showQR').addEventListener('click', () => {
            window.electronAPI.showMobileQR();
        });
    ...
    sendTouchEvent(type, x, y) {
        ...
        // Also forward through Electron IPC
        window.electronAPI.forwardTouchEvent(touchData);
    }
    ...
    connectToSignalServer() {
        ...
        this.ws = new WebSocket(`ws://localhost:${this.signalServerPort}`);
